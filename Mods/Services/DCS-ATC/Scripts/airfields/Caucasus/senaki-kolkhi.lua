...
controllers = { ground=true, tower=true, approach=true, departure=true },
    ...
    crps = {
        ...
        { name="Senaki-Kolkhi CRP5", seq=5, x=-282449.59516452, y=638116.87995788, radius=1388.6688 },
        { name="Senaki-Kolkhi CRP6", seq=6, x=-283967.7, y=656076.89, radius=1388.6688 },
    },
    rwy = {
