ATC.runways["Kobuleti"] = { hdg=70, reciprocal=250, elevation=59, ILSfreq=111.50, patternAlt=1559, patternDir="R",
    ...
    crps = {
        ...
        { name="Kobuleti CRP5", seq=5, x=-323537.79747575, y=628455.40613702, radius=1388.6688 },
        { name="Kobuleti CRP6", seq=6, x=-316912.0443654, y=644610.73316067, radius=1388.6688 },
    },
}
