ATC.runways["Krasnodar-Pashkovsky"] = { hdg=40, reciprocal=220, elevation=98, ILSfreq=0, patternAlt=1608,
    frequencies = {
    ...
    crps = {
        { name="Krasnodar-Pashkovsky CRP1", seq=1, x=-4999.163179666, y=389254.98077371, radius=3703.9296 },
    ...
    rwy = {
        ...
        { x=8733.43, y=389014.13 },
        { x=8777.16, y=388973.91 },
        { x=6685.53, y=386729.62 },
    },
}
