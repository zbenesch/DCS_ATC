ATC.runways["Maykop-Khanskaya"] = { hdg=40, reciprocal=220, elevation=591, ILSfreq=0, patternAlt=2091,
    ...
    crps = {
        { name="Maykop-Khanskaya CRP1", seq=1, x=-27365.471902336, y=445308.94141996, radius=3703.9296 },
    ...
    rwy = {
        ...
        { x=-25217.36, y=459072.98 },
        { x=-25182.2, y=459027.94 },
        { x=-27666.57, y=457014.34 },
    },
}
